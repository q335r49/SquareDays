...
class Interval {
    ...
    Interval(Interval e) {                                                                      this    (e.command,e.type,e.paint.getColor(),e.start,e.end,    e.group,e.label,e.comment);}
    ...
    static Interval newCompleteTask(int color, long start, long dur, String label) { return new Interval(cNULL,    tCAL,  color,             start,  start+dur,0,      label,  null     );}
